...
export default function InfoPollen() {
  ...
  return (
    <Section id='alertepollen' small>
      ...
      <Big>
       <p>Lorsque vous pratiquez un effort physique, la quantité d'air inhalé est 7 à 8 fois plus importante qu'au repos. Vous êtes donc plus exposé à la pollution de l'air. </p>
